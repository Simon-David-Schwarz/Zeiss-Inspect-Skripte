...
for stufe in gom.app.project.stages:
	...
	print("Winkelauflösung" + str(winkelaufloesung))
#========================================================================================================#
...
for stufe in gom.app.project.stages:
	...
	ergebnis[stufe.name]['Wanddicke_Außenbogen'] = np.zeros(winkelaufloesung.shape[0])
	ergebnis[stufe.name]['Wanddicke_Innenbogen'] = np.zeros(winkelaufloesung.shape[0])
	...
	for i in range(winkelaufloesung.shape[0]):
		...
		# Unrundheit berechnen
		ergebnis[stufe.name]['Unrundheit'][i] = np.round((ergebnis[stufe.name]['Nebenachse'][i] - ergebnis[stufe.name]['Hauptachse'][i]) / rohrhöhe, 2)
		#============
		...
		ergebnis[stufe.name]['Kruemmung(Winkel)'][i] = np.round(gom.app.project.inspection['Projektionspunkt_Schwerpunkt_B_Bogenschnitt_' + str(winkel) + '.kappa'].result_dimension, 3)
		
		# Wanddicken am Innen- und Außenbogen auslesen
		ergebnis[stufe.name]['Wanddicke_Außenbogen'][i] = np.absolute(np.round(gom.app.project.inspection['Flaechenkurve_Aussenbogen.sd - Wanddicke'].deviation_label['Flaechenkurve_Aussenbogen.sd - Wanddicke.' + str(i+1)].result_dimension, 2))
		ergebnis[stufe.name]['Wanddicke_Innenbogen'][i] = np.absolute(np.round(gom.app.project.inspection['Flaechenkurve_Innenbogen.sd - Wanddicke'].deviation_label['Flaechenkurve_Innenbogen.sd - Wanddicke.' + str(i+1)].result_dimension, 2))
	...
	fh = open(dateiverzeichnis.replace('\\', '/') + '/' + 'skalare_Parameter' + '.csv', 'w', encoding='utf-8')
	...
	fh = open(dateiverzeichnis.replace('\\', '/') + '/' + 'winkelabhaengige_auswertungen' + '.csv', 'w', encoding='utf-8')
...
#--> Wanddickenverlauf am Innenbogen selektieren
# gom.script.cad.show_element_exclusively (elements=[gom.app.project.inspection['Flaechenkurve_Innenbogen.sd - Wanddicke'],
	#gom.app.project.inspection['Flaechenkurve_Aussenbogen.sd - Wanddicke']])
	
gom.script.cad.show_element_exclusively (elements=[gom.app.project.inspection['Flaechenkurve_Innenbogen.sd - Wanddicke']])

#--> Wanddickenverlauf am Innenbogen exportieren
gom.script.diagram.export_diagram_contents (
	cell_separator=';', 
	codec='utf-8', 
	decimal_separator='.', 
	file=dateiverzeichnis + '\wanddicke_innenbogen.csv', 
	header_export=True, 
	line_feed='\n', 
	text_quoting='', 
	type='curves')
...
#--> Wanddickenverlauf am Außenbogen selektieren
gom.script.cad.show_element_exclusively (elements=[gom.app.project.inspection['Flaechenkurve_Aussenbogen.sd - Wanddicke']])

#--> Wanddickenverlauf am Außenbogen exportieren
gom.script.diagram.export_diagram_contents (
	cell_separator=';', 
	codec='utf-8', 
	decimal_separator='.', 
	file=dateiverzeichnis + '\wanddicke_aussenbogen.csv', 
	header_export=True, 
	line_feed='\n', 
	text_quoting='', 
	type='curves')
...
#========================================================================================================#
#-> CSV-Daten in Python Einlesen und anschließend in Excel-Auswertung einfügen
#========================================================================================================#
#Excel Workbook öffnen
EXPORTDATEN_KPL= load_workbook(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', keep_vba=True)
#========================================================================================================#
# Vorherige Exceldaten löschen 
for sheet in EXPORTDATEN_KPL.sheetnames:
	ws =EXPORTDATEN_KPL[sheet]
	for row in ws.iter_rows():
		for cell in row:
			if isinstance(cell.value, (int,float)):
				cell.value = None
#========================================================================================================#
# Koordinaten-Aussenbogen 
start_time_csv = time.time()
# CSV-Datei auslesen
df_Koordinaten_Aussenbogen = pd.read_csv(dateiverzeichnis + '\koordinaten_aussenbogen.csv') 
stop_time_csv = time.time()
elapsedtime_csv =  (stop_time_csv - start_time_csv)
print('elapsedtime_csv:' + str(elapsedtime_csv))

# Daten übertragen
start_time_Excel = time.time()

with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Koordinaten_Aussenbogen.to_excel(writer, sheet_name='koord_aussenbogen', index=False, startrow=0, startcol=0)

stop_time_Excel = time.time()
elapsedtime_Excel =  (stop_time_Excel - start_time_Excel)	
print('elapsedtime_Excel Koordinaten Aussenbogen:' + str(elapsedtime_Excel))
#========================================================================================================#
# Koordianten-Innenbogen

# CSV-Datei auslesen
df_Koordinaten_Innenbogen = pd.read_csv(dateiverzeichnis + '\koordinaten_innenbogen.csv')

# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Koordinaten_Innenbogen.to_excel(writer, sheet_name='koord_innenbogen', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Koordianten-Polylinien

# CSV-Datei auslesen
df_Koordinaten_Polylinien = pd.read_csv(dateiverzeichnis + '\koordinaten_polylinien.csv')

# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Koordinaten_Polylinien.to_excel(writer, sheet_name='koord_polylinien', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Koordianten-Schwerpunkte

# CSV-Datei auslesen
df_Koordinaten_Schwerpunkte = pd.read_csv(dateiverzeichnis + '\koordinaten_schwerpunkte.csv')
# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Koordinaten_Schwerpunkte.to_excel(writer, sheet_name='koord_schwerpunkte', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Kruemmung

# CSV-Datei auslesen
df_Kruemmung = pd.read_csv(dateiverzeichnis + '\kruemmung.csv')
# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Kruemmung.to_excel(writer, sheet_name='kruemmung', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Skalare-Parameter

# CSV-Datei auslesen
df_Skalare_Parameter = pd.read_csv(dateiverzeichnis + '\skalare_Parameter.csv')
# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Skalare_Parameter.to_excel(writer, sheet_name='skalare Parameter', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Wanddicke Aussenbogen

# CSV-Datei auslesen
df_Wanddicke_Aussenbogen = pd.read_csv(dateiverzeichnis + '\wanddicke_aussenbogen.csv')
# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Wanddicke_Aussenbogen.to_excel(writer, sheet_name='wanddicke', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Wanddicke Innenbogen

# CSV-Datei auslesen
df_Wanddicke_Innenbogen = pd.read_csv(dateiverzeichnis + '\wanddicke_innenbogen.csv')
# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Wanddicke_Innenbogen.to_excel(writer, sheet_name='wanddicke', index=False, startrow=0, startcol=2)
#========================================================================================================#
# Winkelabhänige Auswertung

# CSV-Datei auslesen
df_Winkelabhaenige_Auswertung = pd.read_csv(dateiverzeichnis + '\winkelabhaengige_auswertungen.csv')
# Daten übertragen
with pd.ExcelWriter(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm', engine = 'openpyxl', mode = 'a', if_sheet_exists = 'overlay') as writer:

	df_Winkelabhaenige_Auswertung.to_excel(writer, sheet_name='winkelabh_Auswertungen', index=False, startrow=0, startcol=0)
#========================================================================================================#
# Excel Workbook speichern und schließen
EXPORTDATEN_KPL.close()
EXPORTDATEN_KPL.save(dateiverzeichnis + '\EXPORTDATEN_KPL.xlsm')

# Exportdauer ermitteln
StoppUhr_ende = time.time()
Exportdauer= (StoppUhr_ende - StoppUhr_start)/60

#Export Ende anzeigen
print('Export abgeschlossen !')
print('Die Exportdauer betrug:' + str(Exportdauer) + 'Minuten')
