...
def Fkt_Export_Rechteck(startwinkel, schrittweite, rohrhöhe):
	...
	for stufe in gom.app.project.stages:
		...
		for i in range(winkelaufloesung.shape[0]):
			...
			ergebnis[stufe.name]['Unrundheit_ungerundet'][i] = ((ergebnis[stufe.name]['Nebenachse'][i] - ergebnis[stufe.name]['Hauptachse'][i]) / rohrhöhe)*100 # Soll hier die Rohrhöhe oder die Rohrbreite verwendet werden ? 
