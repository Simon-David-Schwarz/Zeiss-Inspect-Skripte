...
# Werkzeug- und Halbzeugparameter
aussendurchmesser_rohr = 30.0 #EINGABE
...
startwinkel = 0 #EINGABE
schrittweite = 1.5 #EINGABE
...
for stufe in gom.app.project.stages:
	...
	for i in range(winkelaufloesung.shape[0]):
		...
		ergebnis[stufe.name]['Unrundheit'][i] = np.round((ergebnis[stufe.name]['Nebenachse'][i] - ergebnis[stufe.name]['Hauptachse'][i]) / aussendurchmesser_rohr, 2)
		#============
		...
		#-> Einfall berechnen
		ergebnis[stufe.name]['Einfall'][i] = np.round(ergebnis[stufe.name]['Radius_R(winkel)'][i] + (aussendurchmesser_rohr / 2) - ergebnis[stufe.name]['Radius_Ra(winkel)'][i], 2)
		#==============
